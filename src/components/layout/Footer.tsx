        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4 flex items-center">
              <span className="text-white">Distribuidora</span><span className="text-renata-yellow ml-1">Renata</span>
            </h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/renatadistribuidoracba" target="_blank" rel="noopener noreferrer" className="text-white hover:text-renata-yellow transition-colors">
                <Instagram size={20} />
              </a>
              <a href="#" className="text-white hover:text-renata-yellow transition-colors">
                <Twitter size={20} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Mariano Fragueiro 3746, Córdoba, Argentina</span>
              </li>
              <li className="flex items-center">
                <Phone size={18} className="mr-2 text-renata-yellow" />
                <a href="tel:+5493512742582" className="text-gray-300 hover:text-renata-yellow transition-colors">
                  +54 9 351 274-2582
                </a>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-700 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {year} DistribuidoraRenata. Todos los derechos reservados. Desarrollo full-stack app por JIDevs.
            </p>
